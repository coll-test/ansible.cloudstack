...
import ansible_collections.ansible.cloudstack.tests.unit.compat.unittest as unittest
from ansible_collections.ansible.cloudstack.tests.unit.compat.mock import MagicMock
from ansible_collections.ansible.cloudstack.tests.unit.compat.unittest import TestCase
from ansible_collections.ansible.cloudstack.tests.unit.modules.utils import set_module_args


# Exoscale's cs doesn't support Python 2.6
pytestmark = []
if sys.version_info[:2] != (2, 6):
    from ansible_collections.ansible.cloudstack.plugins.modules.cs_traffic_type import AnsibleCloudStackTrafficType, setup_module_object
    from ansible_collections.ansible.cloudstack.plugins.module_utils.cloudstack import HAS_LIB_CS
    if not HAS_LIB_CS:
